...
function runtimeRequire(modulePath) {
  ...
  // Use eval to avoid Webpack hoisting the dynamic require into the bundle.
...
async function startBackend() {
  ...
  backendStartPromise = (async () => {
    ...
    registerModulePath(path.join(appPath, 'node_modules'));
    registerModulePath(path.join(process.resourcesPath, 'app.asar', 'node_modules'));
    registerModulePath(path.join(process.resourcesPath, 'app.asar.unpacked', 'node_modules'));
    registerModulePath(path.join(process.resourcesPath, 'node_modules'));
